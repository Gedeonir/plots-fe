...
export default function DetailsOfPlot() {
  ...
  return (
    <Layout>
        <NavBar/>
        <div className='lg:flex justify-between sm:block px-3 py-3 max-w-5xl mx-auto rounded-lg min-h-screen drop-shadow-lg shadow-lg my-5'>
            <div className='lg:w-2/4 sm:w-full px-2 py-5 block'>
                ...
                <div className="lg:grid lg:grid-cols-2 gap-2 w-full my-4">
                    <div className='border px-2 py-2 rounded-lg my-2'>
                        ...
                        <div className='flex justify-between'>
                            ...
                            <button className=' px-4 rounded-lg text-gray-300 hover:bg-transparent border border-red-700 transition-all duration-150 text-xs py-1'>Buy</button>
                        </div>
                    </div>
                    <div className='border px-2 py-2 rounded-lg my-2'>
            ...
            <div className='w-96'>
                ...
                >
                    ...
                    <div className='py-2 w-full'>
                        <h3 className="text-sm font-medium text-left text-gray-900 uppercase dark:text-gray-300">Plot name</h3>
