...
export default function Card(props) {
  ...
  return (
        // <Link to="/plots/1/details" className='hover:opacity-80 transition-all duration-700'>
            ...
            <div className='relative mb-2 px-2 h-64'>
                <div className='flex justify-end mb-1 rounded-t-2xl'>
                    <p className='text-xs italic '>#music</p>
                    <p className='text-xs italic mx-2 '>#movie</p>

                </div>
                <img
                    className="shrink-0 relative w-full h-56  bg-cover bg-no-repeat bg-center items-center mb-1"
                    src={props.image}/>
                <div className='py-1 my-2 mx-3 rounded-lg px-3 text-center bg-secondary opacity-80 absolute top-5 right-3'>
                ...
                <div className='flex justify-between rounded-b-2xl'>
                    <div className='flex justify-start '>
                        ...
                        <p className='text-xs text-left italic'>Kigali,Rwanda</p>
                    </div>
                    <div className='flex justify-start '>
            ...
            <div className='relative left-0 right-0 bottom-0 py-2  w-full flex justify-between'> 
                <div className='flex justify-start px-5 rounded-r-full py-[1px]'>
                    <div className="rounded-full relative block"><AiOutlineHeart/> <p className='text-xs text-center'>10.2k</p></div>
                    <div className="rounded-full relative mx-2.5"><AiOutlineComment /> <p className='text-xs text-center'>10.2k</p></div>
                </div>
                <div className='flex justify-start rounded-lg px-2 text-sm'>
                    <p className='py-1'>$5-$5000</p>
                </div>
                <div className='flex justify-start px-5 py-2 rounded-l-full'>
                    <div className="rounded-full relative mx-2.5"><HiOutlineFlag /></div>
                    <div className="rounded-full relative"><TbShare3/></div>
